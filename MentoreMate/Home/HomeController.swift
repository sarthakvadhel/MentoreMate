...
//  InstagramClone
//
//  Created by Sarthak Vadhel on 1/18/24.
...
class HomeController: HomePostCellViewController {
    ...
    private func configureNavigationBar() {
        ...
        logoImageView.contentMode = .scaleToFill // Adjust content mode as needed
        logoImageView.widthAnchor.constraint(equalToConstant: 100).isActive = true
        logoImageView.heightAnchor.constraint(equalToConstant: 50).isActive = true // Adjust height constraint as needed
